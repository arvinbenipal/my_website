...
const Content = () => {
    return (
            <div id="Content" className="h-screen bg-black flex flex-col justify-center">
                <div classname= "lg:grid lg:grid-cols-2">
                    <div >
                        <img alt="car" className="mx-auto h-40 md:h-48" src={ImageOne} />
                    </div>
                    <div >
                        <h1 className="p-12 md:px-48 lg:px-72 font-mono text-white text-center lg:text-lg md:text-md text-xs">
