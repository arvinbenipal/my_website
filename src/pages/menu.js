    ...
    return (
        <div className="h-screen px-8 bg-black">
            <div className="flex justify-center">
                <h1 className="text-3xl font-bold text-gray-200 font-mono pt-14 tracking-widest"> MY SKILLS</h1>
            </div>

            <div className="overflow-y-visible relative w-full filter blur-2xl">
            ...
            <div className="lg:px-48 pt-8 md:pt-14">
                ...
                <div className="flex p-6 bg-gray-800 rounded-3xl shadow-lg opacity-80">
                    <ul className="font-mono text-xs text-white g:text-sm px-3">
